    ...
    <div className="gallery-container">
      ...
      <Grid
        ...
        effectConfig={{
          ...
          // Advanced movement
          rotationRange: {                     // Dynamic 3D rotation
            x: [-2, 2],
            y: [-3, 3],
            z: [-5, 5]
          },
          ...
          physicsConfig: {                     // Realistic motion parameters
            gravity: 980,
            bounce: 0.35,
            friction: 0.12,
            turbulence: 0.08
          ...
          particleEmission: {                  // Particle effects during transition
            count: 8,
            lifespan: 0.8,
            size: [2, 5],
          ...
          blurTransition: {                    // Dynamic blur during animation
            start: 0,
            peak: 3.5,
            end: 0
          },
